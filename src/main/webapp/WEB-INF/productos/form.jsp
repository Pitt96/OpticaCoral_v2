...
<%@page import="pe.com.coral.beans.Proveedor"%>
                ...
                <div class="col">
                    <form class="form" action="productos" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="precionP" name="precion" step="0.01" placeholder="Precio unitario nuevo..." value="<% if (tipoForm.equals("Actualizar")) {
