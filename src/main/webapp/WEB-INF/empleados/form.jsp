...
<%@page import="pe.com.coral.beans.Pais"%>
<%@page import="pe.com.coral.beans.TipoEmpleado"%>
<%@page import="pe.com.coral.beans.Empleado"%>
<%@page import="pe.com.coral.beans.Estado"%>
<%@page import="java.util.List"%>
<%@page import="pe.com.coral.beans.Direccion"%>
