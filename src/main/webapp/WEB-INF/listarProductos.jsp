<%@page import="pe.com.coral.beans.Login"%>
<%@page import="pe.com.coral.vistas.VPromedio"%>
<%@page import="pe.com.coral.vistas.VCategoria"%>
<%@page import="pe.com.coral.beans.Marca"%>
<%@page import="pe.com.coral.beans.Categoria"%>
<%@page import="pe.com.coral.beans.Producto"%>
<%@page import="java.util.List"%>
<%@page import="pe.com.coral.vistas.VMarca"%>
...
<html lang="es">
    <head>
        ...
        <title>Inicio |  Optica coral</title>
