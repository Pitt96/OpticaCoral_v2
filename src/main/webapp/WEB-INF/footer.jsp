            ...
            <div class="row">
                <div class="col-sm-2">
                    <div class="companyinfo">
                        <h2><span>optica</span>-coral</h2>
                        <p>Somos Optica El Coral, una empresa de la multinacional Luxottica, líder en diseño, fabricación y distribución de lentes de moda.</p>
                    </div>
                </div>
                <div class="col-sm-7">
                    <div class="col-sm-3">
                        <div class="video-gallery text-center">
                            <a href="#">
                                <div class="iframe-img">
                                    <img src="tienda/images/home/marca_famosa.jpg" alt="" />
                                </div>
                    ...
                    <div class="col-sm-3">
                        <div class="video-gallery text-center">
                            <a href="#">
                                <div class="iframe-img">
                                    <img src="tienda/images/home/cuidado_personal.jpg" alt="" />
                                </div>
                                <div class="overlay-icon">
                                    <i class="fa fa-play-circle-o"></i>
                                </div>
                    ...
                    <div class="col-sm-3">
                        <div class="video-gallery text-center">
                            <a href="#">
                                <div class="iframe-img">
                                    <img src="tienda/images/home/outfit.jpg" alt="" />
                                </div>
                                <div class="overlay-icon">
                                    <i class="fa fa-play-circle-o"></i>
                                </div>
                    ...
                    <div class="col-sm-3">
                        <div class="video-gallery text-center">
                            <a href="#">
                                <div class="iframe-img">
                                    <img src="tienda/images/home/lentes_promociones.jpg" alt="" />
                                </div>
                                <div class="overlay-icon">
                                    <i class="fa fa-play-circle-o"></i>
                                </div>
                ...
                <div class="col-sm-3">
                    <div class="address">
                        <img src="tienda/images/home/map.png" alt="" />
